...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}Token Cleanup Batch Job${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
echo -e "${YELLOW}Starting tokenCleanupJob...${NC}"
echo ""
...
--spring.batch.job.name=tokenCleanupJob \
--spring.task.scheduling.enabled=false \
--spring.main.web-application-type=none \
requestedAt=${TIMESTAMP}"; then
    echo ""
    echo -e "${GREEN}========================================${NC}"
    echo -e "${GREEN}Token Cleanup Job Completed Successfully!${NC}"
    echo -e "${GREEN}========================================${NC}"
else
    echo ""
    echo -e "${RED}========================================${NC}"
    echo -e "${RED}Token Cleanup Job Failed!${NC}"
    echo -e "${RED}========================================${NC}"
    exit 1
fi