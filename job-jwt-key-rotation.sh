...
# JWT Key Rotation Batch Job Runner
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}JWT Key Rotation Batch Job${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
echo -e "${YELLOW}Starting jwtKeyRotationJob...${NC}"
echo ""
...
requestedAt=${TIMESTAMP}"; then
    echo ""
    echo -e "${GREEN}========================================${NC}"
    echo -e "${GREEN}JWT Key Rotation Job Completed Successfully!${NC}"
    echo -e "${GREEN}========================================${NC}"
else
    echo ""
    echo -e "${RED}========================================${NC}"
    echo -e "${RED}JWT Key Rotation Job Failed!${NC}"
    echo -e "${RED}========================================${NC}"
    exit 1
fi